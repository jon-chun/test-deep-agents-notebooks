...
# Summarization model 
# Summarization model (defaults to the notebook-configured backend/model when available)
model_name = os.getenv("DEEP_AGENT_MODEL", "openai:gpt-5-mini")
summarization_model = init_chat_model(model=model_name)
